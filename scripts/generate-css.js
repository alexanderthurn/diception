...
for (const [name, data] of Object.entries(json.frames)) {
    // Strip folder path — frame names are like "game/icon_zoom_in.png"
    const basename = path.basename(name);

    // "icon_ach_tutorial.png" -> "icon-ach-tutorial"
...
try {
    ...
    console.log(`  - Sheet: ${sheetW}x${sheetH}, ${Object.keys(json.frames).length} sprites`);
} catch (e) {
