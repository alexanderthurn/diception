...
function buildGameConfigFromLevel(level, baseConfig, { isCampaign = false, mapSeed } = {}) {
    ...
    const gameConfig = {
        ...
        secondsPerTurn,
        secondsPerAttack,
        fullBoardRule: level?.fullBoardRule ?? baseConfig.fullBoardRule,
        attackRule: level?.attackRule ?? baseConfig.attackRule,
        supplyRule: level?.supplyRule ?? baseConfig.supplyRule,
        playMode: level?.playMode ?? baseConfig.playMode,
